...
public class StandardTokenWrapper
{
    ...
    public static async Task<string> DeployStandardTokenAsync(StratisUnityManager stratisUnityManager, ulong totalSupply, string name, string symbol, uint decimals)
    {
